...
namespace TravelRecordApp
{
	...
	public partial class MapPage : ContentPage
	{
        ...
        private void locationsMap_MapClicked(object sender, Xamarin.Forms.Maps.MapClickedEventArgs e)
        {
            locationsMap.Pins.Add(new Xamarin.Forms.Maps.Pin() { Position = e.Position ,Label="Okay"});
            DisplayAlert("Accept", "Fuck you", "Thunder");
